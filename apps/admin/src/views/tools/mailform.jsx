...
var defaultState = {
  ...
  height: "dynamic",
  title: "Tyck till",
  description: "Skicka en synpunkt om kartan",
  instructions: "",
  recipientEmail: "",
  subject: "Synpunkt från kartan",
  ...
  constructor(props) {
    ...
    if (tool) {
      this.state = {
        ...
        height: tool.options.height || "dynamic",
        title: tool.options.title || defaultState.title,
        description: tool.options.description || defaultState.description,
        instructions: tool.options.instructions || "",
        recipientEmail: tool.options.recipientEmail || "",
        subject: tool.options.subject || defaultState.subject,
  ...
  save() {
    ...
    if (!this.state.active) {
      ...
      if (!this.state.recipientEmail) {
        this.props.parent.props.parent.setState({
          alert: true,
          alertMessage: "Mottagarens e-postadress måste anges.",
        });
        return;
      }
      if (existing) {
    ...
    return (
      <div>
        <form>
          ...
          <div className="separator">E-postinställningar</div>
          <div>
            <label htmlFor="recipientEmail">
              ...
              <i
                className="fa fa-question-circle"
                data-toggle="tooltip"
                title="E-postadressen som synpunkten adresseras till. Obligatorisk."
              />
            </label>
            <input
              id="recipientEmail"
          ...
          <div>
            <label htmlFor="instructions">
              ...
              <i
                className="fa fa-question-circle"
                data-toggle="tooltip"
                title="Valfri hjälptext som visas ovanför formuläret i verktyget."
              />
            </label>
            <textarea
              id="instructions"
