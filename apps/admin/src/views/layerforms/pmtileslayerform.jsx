...
class PMTilesLayerForm extends Component {
  constructor() {
    super();
  ...
  render() {
    return (
      <div>
        ...
        <p>
          <label>URL till PMTiles-arkiv*</label>
          <input
            type="text"
            className={`control-fixed-width ${this.fieldHasError("url")}`}
            placeholder="https://exempel.se/basemap.pmtiles"
          ...
          <div>
            ...
            <p>
              ...
              <input
                ...
                onChange={(e) => this.setState({ infoUrlText: e.target.value })}
              />
            </p>
            <p>
...
export default PMTilesLayerForm;
