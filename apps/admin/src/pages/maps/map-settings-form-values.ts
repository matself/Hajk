...
function buildOptionsFormValues(
  ...
  return {
    ...
    constrainResolutionMobile: fromOptionFlag(options.constrainResolutionMobile),
...
function formOptionsFromValues(data: FieldValues): Record<string, string> {
  ...
  return {
    ...
    centerCoordinate: toStringValue(options.centerCoordinate, "576357, 6386049"),
    ...
    zoomAnimationDuration: String(toNumber(options.zoomAnimationDuration) ?? ""),
